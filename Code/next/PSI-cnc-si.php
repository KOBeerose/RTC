...
?>
<head>
	<title>PSI CNC <?php echo $row['5']['subjects'] ?></title>
	...
	<div class="container">
   		<ol class="breadcrumb mb-4">
			...
			<li class="breadcrumb-item"><a href="<?php echo "PSI-cnc-si.php?language=" . $language ?>"><?php echo $row['5']['subjects'] ?></a></li>
 		</ol>
	</div>
	<div id="fh5co-course">
		<div class="container">
		<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					...
					<p><?php echo $row['15']['page_content'] ?><a href="pdfs/PSI/cnc/si/PSI SI CNC.rar" download ><?php echo $row['12']['important'] ?></a></p>
				</div>
			</div>
			<div class="table">
				<tbody >
