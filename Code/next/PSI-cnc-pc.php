				...
				<tbody >
					<table>
						...
						<tr class="tbl-cnt">
							...
							<td><a href="pdfs/PSI/cnc/pc/CNC 2003 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td>-</td>
						</tr>
						<tr>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2004 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td>-</td>
						</tr>
						<tr>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2005 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td>-</td>
						</tr>
						<tr>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2006 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td>-</td>
						</tr>
						<tr>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2008 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td>-</td>
						</tr>
						<tr>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2009 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td>-</td>
						</tr>
						<tr>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2010 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td>-</td>
						</tr>
						<tr>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2011 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td>-</td>
						<tr>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2012 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td>-</td>
						</tr>
						<tr>
							...
							<td><a href="pdfs/PSI/cnc/pc/CNC 2013 Physique-1 PSI Correction.pdf" target="_blank">Correction</a></td>
						</tr>
						<tr class="tbl-cnt">
							<td><?php echo $row['0']['subjects'] . ' 2' ?></td>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2013 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td>-</td>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2014 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td>-</td>
						</tr>
						<tr>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2015 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td>-</td>
						</tr>
						<tr>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2016 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td>-</td>
						</tr>
						<tr>
							...
							<td><a href="pdfs/PSI/cnc/pc/CNC 2017 Physique-1 PSI Correction.pdf" target="_blank">Correction</a></td>
						</tr>
						<tr class="tbl-cnt">
							<td><?php echo $row['0']['subjects'] . ' 2' ?></td>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2017 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td>-</td>
						</tr>
						<tr>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2018 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2018 Chimie PSI Correction.pdf" target="_blank">Correction</a></td>
						</tr>
						<tr>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2019 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2019 Chimie PSI Correction.pdf" target="_blank">Correction</a></td>
						</tr>
						<tr>
						...
						<tr class="tbl-cnt">
							<td><?php echo $row['1']['subjects'] ?></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2020 Chimie PSI.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td><a href="pdfs/PSI/cnc/pc/CNC 2020 Chimie PSI Correction.pdf" target="_blank">Correction</a></td>
						</tr>
					</table>
