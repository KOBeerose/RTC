...
const closeModalButtons = document.querySelectorAll('[data-close-input]')
const overlay = document.getElementById('overlay')

openModalButtons.forEach(input => {
	input.addEventListener('click', () => {
		const idnt = document.querySelector(input.dataset.idntTarget)
		openModal(idnt)
	})
})
