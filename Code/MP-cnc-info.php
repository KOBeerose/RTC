				...
				<tbody >
					<table>
						...
						<tr>
							...
							<td><?php echo $row['2']['subjects'] ?></td>
							<td><a href="pdfs/MP/cnc/info/CNC Info 2020.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td><a href="pdfs/MP/cnc/info/CNC Info 2020 Correction.pdf" target="_blank">Correction</a></td>
						</tr>
