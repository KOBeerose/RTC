...
?>
<head>
	<title>TSI CNC <?php echo $row['2']['subjects'] ?></title>
	...
	<div class="container">
   		<ol class="breadcrumb mb-4">
			...
			<li class="breadcrumb-item"><a href="<?php echo "TSI-cnc-info.php?language=" . $language ?>"><?php echo $row['2']['subjects'] ?></a></li>
 		</ol>
	</div>
	<div id="fh5co-course">
		<div class="container">
		<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					...
					<p><?php echo $row['15']['page_content'] ?><a href="pdfs/TSI/cnc/info/TSI Info CNC.rar" download ><?php echo $row['12']['important'] ?></a></p>
				</div>
			</div>
			<div class="table">
				<tbody >
					<table>
						...
						<tr>
							...
							<td><a href="pdfs/TSI/cnc/info/CNC Info 2015.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td><a href="pdfs/TSI/cnc/info/CNC Info 2015 Correction.pdf" target="_blank">Correction</a></td>
						</tr>
						<tr>
							<td class="tbl-cnt" rowspan="1" style="text-align: center;">2016</td>
							<td><?php echo $row['2']['subjects'] ?></td>
							<td><a href="pdfs/TSI/cnc/info/CNC Info 2016.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td><a href="pdfs/TSI/cnc/info/CNC Info 2016 Correction.pdf" target="_blank">Correction</a></td>
						</tr>
						<tr>
							<td class="tbl-cnt" rowspan="1" style="text-align: center;">2017</td>
							<td><?php echo $row['2']['subjects'] ?></td>
							<td><a href="pdfs/TSI/cnc/info/CNC Info 2017.pdf" target="_blank"><?php echo $row['8']['page_header'] ?></a></td>
							<td><a href="pdfs/TSI/cnc/info/CNC Info 2017 Correction.pdf" target="_blank">Correction</a></td>
						</tr>
						<tr>
